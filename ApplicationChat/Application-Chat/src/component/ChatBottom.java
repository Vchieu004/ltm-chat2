...
public class ChatBottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        cmd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!text.equals("")) {
                    Model_Send_Message message = new Model_Send_Message(Service.getInstace().getUser().getUserID(),user.getUserID(),text);
                    send(message);
    ...
    private static class MigLayout implements LayoutManager {
        ...
        public MigLayout(String filly, String string, String bottom0) {
        }
    }
